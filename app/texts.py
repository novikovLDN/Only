...
TEXTS = {
    "ru": {
        ...
        "tz_confirmation_message": "🕒 Часовой пояс успешно изменён.\n\nВсе уведомления теперь будут приходить по новому времени.\n\nТекущий: {tz}",
    ...
    "en": {
        ...
        "tz_confirmation_message": "🕒 Timezone successfully updated.\n\nAll reminders will now follow your new local time.\n\nCurrent: {tz}",
