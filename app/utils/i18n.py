...
TRANSLATIONS = {
    "ru": {
        ...
        "preset.choose_title": "✨ Выберите привычки",
        "preset.choose_subtitle": "Отметьте то, что хотите отслеживать.\nВы всегда сможете изменить выбор.",
        "preset.select_at_least_one": "Выберите хотя бы одну привычку",
        "preset.nav_back": "⬅️ Назад",
        "preset.nav_next": "➡️ Далее",
        "preset.page_prev": "◀️",
        "preset.page_next": "▶️",
    ...
    "en": {
        ...
        "preset.choose_title": "✨ Choose your habits",
        "preset.choose_subtitle": "Select what you'd like to track.\nYou can change this anytime.",
        "preset.select_at_least_one": "Select at least one habit",
        "preset.nav_back": "⬅️ Back",
        "preset.nav_next": "➡️ Next",
        "preset.page_prev": "◀️",
        "preset.page_next": "▶️",
