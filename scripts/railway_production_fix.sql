...
-- 3️⃣ ADD missing columns in payments (YooKassa/Telegram Invoice)
ALTER TABLE payments
ADD COLUMN IF NOT EXISTS tariff VARCHAR(50) NOT NULL DEFAULT '1_month';

ALTER TABLE payments
ADD COLUMN IF NOT EXISTS provider VARCHAR(50) NOT NULL DEFAULT 'card';
...
-- payments.user_id MUST reference users.id (FK exists in model)
